...
class CategoryMtsDetailsProvider extends GetConnect {
  Future<dynamic> getMTREssentialDetails(String apiToken, String language) async {
    final response = await post(Api.mtrCmsDetails,
        {
