...
class CustomButtonNotification extends StatefulWidget {
  ...
  var borderRadius;
  TextStyle? style;
  CustomButtonNotification({Key? key,this.title,this.backgroundColor,this.primary,this.onPressed,this.padding,this.borderRadius,this.style}) : super(key: key);

  @override
  _CustomButtonState createState() => _CustomButtonState();
}

class _CustomButtonState extends State<CustomButtonNotification> {
  @override
